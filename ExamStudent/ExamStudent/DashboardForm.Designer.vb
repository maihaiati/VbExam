...
Partial Class DashboardForm
	...
	Private Sub InitializeComponent()
		...
		btnScoreView = New ToolStripMenuItem()
		...
		MenuStrip1.Items.AddRange(New ToolStripItem() {btnMe, btnScoreView})
		...
		' btnScoreView
		' 
		btnScoreView.Name = "btnScoreView"
		btnScoreView.Size = New Size(90, 20)
		btnScoreView.Text = "Xem điểm thi"
		' 
		' DashboardForm
		' 
	...
	Friend WithEvents btnScoreView As ToolStripMenuItem
End Class
