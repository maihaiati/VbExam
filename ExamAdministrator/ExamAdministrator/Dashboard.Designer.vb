...
Partial Class Dashboard
	...
	Private Sub InitializeComponent()
		...
		MenuStrip1.Items.AddRange(New ToolStripItem() {btnAccount, btnExam, btnResult, btnMe, btnmonhoc, btnKhoa, btnLog})
		...
		lblLoiChao.Location = New Point(287, 104)
		...
		lblTime.Location = New Point(246, 194)
		...
		' 
		btnLog.Name = "btnLog"
		btnLog.Size = New Size(111, 20)
		btnLog.Text = "Nhật ký hệ thống"
		' 
		' Dashboard
		' 
	...
	Friend WithEvents btnLog As ToolStripMenuItem
End Class
